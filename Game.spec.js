describe('A tic tac toe game', function(){
  ...
  describe('Check the winner', function(){
    ...
    it('If the player 1 makes the first hrizontal line', function(){
      TicTacToe.board = [ 1, 1, 1, 2, null, null, 2, null, null ]
      expect(TicTacToe.winner(TicTacToe.board,1)).toBe(1)
    })

    it('If the player 2 makes the the middle vertical line', function(){
      TicTacToe.board = [ null, 2, null, 1, 2, null, 1, 2, 1 ]
      expect(TicTacToe.winner()).toBe(2)
    })

    it('If the player 2 makes the second diagonal line', function(){
      TicTacToe.board = [ 1, null, 2, null, 2, null, 2, 1, 1 ]
      expect(TicTacToe.winner()).toBe(2)
    })

    it('If there is no winner and the board is full', function(){
      TicTacToe.board = [ 1, 2, 1, 1, 2, 2, 2, 1, 2 ]
